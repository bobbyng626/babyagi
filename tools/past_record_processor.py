...
# from custom_prompt_template import PastRecordProcessorTemplate
from utils import OpenAIQuery
import json
from pydantic import BaseModel, Field

class PastRecordProcessorInput(BaseModel):
...
class PastRecordProcessorTool(BaseTool):
    ...
    description = """
        ...
        """
    args_schema: Type[BaseModel] = PastRecordProcessorInput
...
#     prompt = PastRecordProcessorTemplate.create_prompt_template(
