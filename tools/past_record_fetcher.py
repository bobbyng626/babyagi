...
class PastRecordFetcherInput(BaseModel):
...
class PastRecordFetcherTool(BaseTool):
    ...
    description = """
        ...
        """
    args_schema: Type[BaseModel] = PastRecordFetcherInput
...
#     prompt = PastRecordFetcherTemplate.create_prompt_template(
